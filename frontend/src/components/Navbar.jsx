                        ...
                        <div ref={menuref} className='relative'>
                            ...
                            >
                              <div className='relative'>
                                {user.avatar ? (
                                  <img src={user.avatar} alt='avatar' className='w-9 h-9 rounded-full drop-shadow-sm'/>
                                ):(
                            ...
                            {menuOpen && (
                              <ul className='absolute top-14 right-0 w-56 bg-white rounded-2xl shadow-xl border-purple-100 z-50 overflow-hidden animate-fadIn'>
                                 <li className='p-2'>
                                     <button className='w-full px-4 py-2.5 text-left hover:bg-purple-50 text-sm text-gray-700 transition-colors flex items-center gap-2 group' role='menuitem'
                                      onClick={()=>{
                                        setMenuOpen(false);
                                        navigate('/profile')
                                      }}
                                 ...
                                 <li className='p-2'>
                                    <button className='flex w-full items-center gap-2 rounded-lg px-3 py-2 text-sm hover:bg-red-50 text-red-600'
