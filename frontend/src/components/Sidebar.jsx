       ...
       <div className={SIDEBAR_CLASSES.desktop}>
          <div className='p-5 border-b border-gray-100 lg:block hidden'> 
            <div className='flex items-center gap-3'>
               <div className='w-10 h-10 rounded-full bg-gradient-to-br from-fuchsia-500 to-purple-600 flex items-center justify-center text-white shadow-md font-bold'>
                  {initials}
               </div>

               <div>
                  <h1 className='text-lg font-bold text-gray-800'>Hey, {userName}</h1>
                  <p className='text-sm text-purple-500 font-medium flex items-center gap-1'><Sparkle className='h-3 w-3'/> Let's crush some Tasks! </p>
               </div>
            </div>
          </div>
          <div className='p-4 space-y-6 overflow-y-auto fleex-1'> 
        ...
        <div className='fixed inset-0 z-40'>
            ...
            <div className={SIDEBAR_CLASSES.mobileDrawer} onClick={(e) => e.stopPropagation()}>
              <div className='flex justify-between items-center mb-4 border-b pb-2'>
                ...
                <button className='text-gray-500 hover:text-purple-600' onClick={() => setMobileOpen(false)}>
                   <X className='w-5 h-5' />
                </button>
              </div>
