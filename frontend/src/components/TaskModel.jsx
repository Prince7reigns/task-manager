...
const TaskModel = ({isOpen, onClose, taskToEdit,onSave,onLogout}) => {
  ...
  return (
    <div className='fixed inset-0 backdrop-blur-sm bg-black/20 z-50 flex items-center justify-center p-4'>
      <div className='bg-white border border-purple-100 rounded-xl max-w-md w-full shadow-lg relative p-6 animated-fadeIn'>
         ...
         <form onSubmit={handleSubmit} className='space-y-4'>
            ...
            <div>
                ...
                <div className='flex items-center border border-purple-100 rounded-xl px-3 py-2.5 focus-within:ring-2 focus-within:ring-purple-500 focus-within:border-purple-500 transition-all duration-200'>
            ...
            <div className='grid grid-cols-2 gap-4'>
               <div>
                  <label className='flex items-center gap-1 text-sm font-medium text-purple-100 mb-1'>
                    <Flag  className='h-4 w-4 text-purple-500'/> Priority
                  </label>
            ...
            <div>
                <label className='flex items-center gap-1 text-sm font-medium text-purple-100 mb-1'>
                    <CheckCircle  className='h-4 w-4 text-purple-500'/> Due Date
                </label>
